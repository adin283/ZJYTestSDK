...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SHAlertViewBlocks/SHAlertViewBlocks.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZJYTestSDK/ZJYTestSDK.framework"
